...
public final class ClockStyle30Configure extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Intent intent2 = new Intent("android.appwidget.action.APPWIDGET_UPDATE", (Uri) null, context, ClockStyle30ProviderReceiver.class);
