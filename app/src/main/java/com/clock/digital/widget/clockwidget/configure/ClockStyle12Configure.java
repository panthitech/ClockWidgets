...
public final class ClockStyle12Configure extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Intent intent2 = new Intent("android.appwidget.action.APPWIDGET_UPDATE", (Uri) null, context, ClockStyle12ProviderReceiver.class);
