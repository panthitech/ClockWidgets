...
public final class ClockStyle29Configure extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Intent intent2 = new Intent("android.appwidget.action.APPWIDGET_UPDATE", (Uri) null, context, ClockStyle29ProviderReceiver.class);
